...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/02 20:11:49 by jibae             #+#    #+#             */
/*   Updated: 2022/05/06 20:59:09 by jibae            ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */

#include "checker_bonus.h"

static int	sorted_a_check(t_stack *stack)
{
	t_node	*temp;
...
int	main(int argc, char **argv)
{
	...
	stack->arr = int_arr;
	check(stack);
	if (stack->size_b == 0 && sorted_a_check(stack))
		write(1, "OK\n", 3);
	else
		write(1, "KO\n", 3);
	return (0);
